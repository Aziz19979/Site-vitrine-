...
<div class="container-fluid" style="height:100%;width:100%"> 
  <div style="display:flex;height:60%;position: relative;top:20%;width:100%">
        <div style="height: 100%;border: 2px solid #000;background:rgba(50,50,50,0.65) ;font-optical-sizing: auto;
         font-size: 2rem; font-stretch: 50%; font-weight: 100;width:50%" class="align-items-center col-6">
          <div  id="slide1">
          </div>
        </div>
