...
<div style="background:rgba(206,211,217,0.3); height:100vh">
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-8 col-md-6">
				...
				<div style="padding:20px; border-style:outset; border-color:black">
					<center><img src="assets/images/logo.jpg" style="height:70px"></center>
					<hr>
					<form method="post" action="index.php?submit=true">
						<div class="form-group">
							<center><h3 style=black><b>Connexion Admin SIANA</b></h3></center>
						</div>
						<div class="form-group">
							<label>Email</label>
